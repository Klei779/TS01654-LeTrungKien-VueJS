...
public boolean validateForm() {
    ...
    // Kiểm tra mã ID chỉ gồm chữ và số, tối đa 10 ký tự
    if (!id.matches("^[a-zA-Z0-9]{1,10}$")) {
        MsgBox.alert(this, "Mã ID chỉ chứa chữ và số, tối đa 10 ký tự!");
        txtIDCategory.requestFocus();
        return false;
    }
    ...
    if (name.isEmpty()) {
        ...
        txtIDNameCategory.requestFocus();
        return false;
    }

    // Kiểm tra tên tối thiểu 3 ký tự
    if (name.length() < 3) {
        MsgBox.alert(this, "Tên Category phải có ít nhất 3 ký tự!");
        txtIDNameCategory.requestFocus();
        return false;
    }
    ...
    if (!name.matches("^[a-zA-Z\\s]+$")) {
        MsgBox.alert(this, "Tên Category chỉ được chứa chữ cái và khoảng trắng!");
        txtIDNameCategory.requestFocus();
        return false;
    }
